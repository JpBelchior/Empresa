import{e as s}from"./funcoes-C6VstcXr.js";function l(){$("#tags").empty(),axios("tags/lista").then(e=>{let t=e.data;for(let a in t){let r=`
                        ...
                        </tr>`;$("#tags").append(r)}}).catch(e=>{s(e)}).finally(()=>{})}export{l};
