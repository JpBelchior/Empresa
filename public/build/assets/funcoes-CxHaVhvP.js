import{e as p}from"./funcoes-CNXYSAtO.js";function d(){$("#tipos_empreendimentos").empty(),axios("tipos_empreendimentos/lista").then(t=>{let e=t.data;for(let s in e){let o=`
