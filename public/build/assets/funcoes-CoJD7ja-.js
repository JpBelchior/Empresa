import{e as s}from"./funcoes-C6VstcXr.js";function l(){$("#tematicas").empty(),axios("tematicas/lista").then(e=>{let t=e.data;for(let a in t){let r=`
                        ...
                        </tr>`;$("#tematicas").append(r)}}).catch(e=>{s(e)}).finally(()=>{})}export{l};
