import{e as r}from"./funcoes-C6VstcXr.js";function l(){$("#topicos").empty(),axios("topicos/lista").then(e=>{let t=e.data;for(let o in t){let a=`
                        ...
                        </tr>`;$("#topicos").append(a)}}).catch(e=>{r(e)}).finally(()=>{})}export{l};
