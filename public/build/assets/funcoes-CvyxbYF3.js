import{e as o}from"./funcoes-B4fFGlcT.js";function p(){$("#tipos_empreendimentos").empty(),axios("tipos_empreendimentos/lista").then(t=>{let e=t.data;for(let s in e){let i=`
