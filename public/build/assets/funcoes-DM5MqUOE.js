import{e as o,b as i}from"./funcoes-BL8f3KCM.js";function d(){$("#formularios").empty(),axios("formularios/lista").then(a=>{let r=a.data;for(let e in r){let t=`
                        ...
                        </tr>`;$("#formularios").append(t)}}).catch(a=>{o(a)}).finally(()=>{})}function n(){let a=$("#formulario_id").val();$("#perguntas_respondidas").empty(),axios.get(app_url+"/formularios/respostas/formulario/"+a).then(r=>{$("#qtd_perguntas_respondidas").html(`(${r.data.length})`);let e=r.data;for(let t in e){let s=`<tr class="bg-white dark:bg-gray-800">                        
                            <td class="px-6 py-4">
                        ...
                        </tr>`;$("#perguntas_respondidas").append(s)}}).catch(r=>{o(r)})}export{n as a,d as l};
