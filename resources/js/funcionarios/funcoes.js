    ...
    axios('funcionarios/lista')
        .then(response => {
            ...
            for (let i in usuarios) {                
                ...
                let botao_editar = `<button usuario="${usuarios[i].id}" type="button" class="editar px-3 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
