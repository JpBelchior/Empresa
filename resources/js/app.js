...
export function badge(palavra, cor){
    let badge;
    switch(cor){
        case 'preto': badge = `<span class="bg-gray-100 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm ">${palavra}</span>`; break;
        case 'vermelho': badge = `<span class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm ">${palavra}</span>`; break;
        case 'verde': badge = `<span class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm ">${palavra}</span>`; break;
        case 'amarelo': badge = `<span class="bg-yellow-100 text-yellow-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm ">${palavra}</span>`; break;        
        default: badge = `<span class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm ">${palavra}</span>`; break;
    };
    return badge;
}