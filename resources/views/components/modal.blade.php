    ...
    <div class="relative p-4 w-full {{ $size }} max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-200">
                <h3 id="label_modal" class="text-xl font-semibold text-gray-900">                    
                    {{ $label }}
                </h3>
                ...
                <button type="button" class="fechar_modal text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="{{ $id }}">
