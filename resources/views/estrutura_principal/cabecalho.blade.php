                ...
                <div class="flex items-center ms-3">
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-sm shadow-sm" id="dropdown-user">
                        ...
                        <ul class="py-1" role="none">
                            <li>
                                <a id="btn_modal_redefinir_senha" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Redefinir Senha</a>
                            </li>
                            @can('administrador', App\Models\User::class)
                            <li>
                                <a id="btn_modal_trocar_empresa" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Trocar empresa</a>
                            </li>
                            @endcan
                            <li>
                                <a id="logout" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Sair</a>
                            </li>                            
                        </ul>
                    </div>
                </div>
