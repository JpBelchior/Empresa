...
<head>
  <meta charset="UTF-8">
  <title>Relatório com Múltiplas Páginas</title>
...
<body>  
  ...
  <!-- <div class="quebra-pagina-normal">
    ...
    <div class="m-4">
      <div class="resumo_sessao">
        <div class="primeira-divisao">
          <img src="{{ asset('img/simbolo_pessoas.png') }}" alt="">
        </div>
        <div class="segunda-divisao">
          <div>
            <svg class="grafico" viewBox="0 0 36 36">
              <circle cx="18" cy="18" r="16" fill="none" stroke="#e5e7eb" stroke-width="5" />
              <circle
                cx="18"
                cy="18"
                r="16"
